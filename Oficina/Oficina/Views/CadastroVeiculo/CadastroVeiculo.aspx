<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CadastroVeiculo.aspx.cs" Inherits="Oficina.Views.CadastroVeiculo.CadastroVeiculo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <asp:Button ID="btnSalvarVeiculo" runat="server" Text="Salvar" OnClick="btnSalvarVeiculo_Click" />
    </div>
    </br>
    <div class="row">
        <div class="col-md-12"></div>
        <asp:Button ID="btnListarVeiculos" runat="server" Text="Listar" OnClick="btnListarVeiculos_Click" />
    </div>
