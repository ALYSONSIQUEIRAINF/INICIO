<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditaCliente.aspx.cs" Inherits="Oficina.Views.Edita.EditaCliente" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <asp:Button ID="btnAlterarCliente" runat="server" Text="Alterar" OnClick="btnAlterarCliente_Click" />
    </div>
